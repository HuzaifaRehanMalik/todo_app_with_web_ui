...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-800 flex items-center justify-center p-6">
      <main className="max-w-md w-full animate-fade-in">
        {/* Header */}
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-400 dark:text-gray-400">Sign in to your account</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="text-center pt-4 border-t border-gray-200 dark:border-slate-700">
              <p className="text-sm text-gray-400 dark:text-gray-400">
                ...
                <Link href="/signup" className="font-semibold text-blue-400 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 transition-colors">
                  Create one
                </Link>
              </p>
            </div>
        ...
        <div className="mt-6 text-center">
          <Link href="/" className="text-sm text-gray-400 dark:text-gray-400 hover:text-gray-500 dark:hover:text-white transition-colors">
            ← Back to home
          </Link>
        </div>
      </main>
